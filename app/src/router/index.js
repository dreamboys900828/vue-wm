...
// ws
import vipdescription from '../components/mine/vipdescription';
import vipcard from '../components/mine/vipcard';
import usecard from '../components/mine/usecard';
import paystyle from '../components/mine/paystyle';
import detail from '../components/mine/detail';
import points from '../components/mine/points';
...
export default new Router({
  ...
  routes: [
    ...
    {path: '/searchCity/:cities/:cName', name: 'searchCity', component: searchCity},
    {
      path: '/shop',
      component: shop,
      children: [
        ...
        {path: 'usecard', component: usecard},
        {path: 'paystyle', component: paystyle},
