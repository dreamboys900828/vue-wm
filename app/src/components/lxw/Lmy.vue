  ...
  <div class="my" ref="register">
    ...
    <div class="infor" @click="skip">
      ...
      <div class="user_infor">
        ...
        <p class="p2">
          <svg t="1564905005519" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
               p-id="9395" width="17" height="17">
            <path
    ...
    <ul class="ul_money">
      ...
      <li>
        <router-link :to="{path:'LmyDiscounts'}">
          <span class="span_money1"><b class="b2">{{infroData== null?0:hb.length}}</b>个</span>
    ...
    <van-cell title="饿了么会员卡" is-link to="vipcard" class="cell van-cell-1"/>
...
<script>
  ...
  export default {
    ...
    created(){
      if (Object.keys(this.USER_STATUS).length === 0) {
    ...
    computed: {
      ...mapState(['USER_STATUS', 'hbNumber']),
    },
    mounted() {
      this.infroData = this.USER_STATUS;
      this.hb = this.hbNumber;
