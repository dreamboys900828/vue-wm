...
<script>
  import Vue from "vue";
  import {exChangeHongbao, getcaptchas} from "../../../service/getData";
  ...
  export default {
    ...
    methods: {
      ...
      async exchange() {
        let message = await exChangeHongbao(this.USER_STATUS.id, this.exchangecode, this.captchacode);
        if (message.message == "无效的兑换码") {
