<template>
  ...
  <div class="newRess">
    ...
    <div class="center">
      ...
      <div class="div1">
        <input type="text" placeholder="请填写能够联系到您的手机号" v-model="Yphone" @input="clickPhone"
               :class="{input1:phoneKuang}">
        <p v-if="phoneIf">{{phoneTS}}</p>
      </div>
      <div class="div1">
        <input type="text" placeholder="备用联系电话（选填）" v-model="byPhone" @input="click1Phone"
               :class="{input1:phone1Kuang}">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState(['USER_STATUS', 'userLocation']),
    }
  }
</script>
